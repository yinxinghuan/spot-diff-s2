...
export const SCENES: SceneDef[] = [
  {
    ...
    differences: [
      ...
      { id: 'occult_2', cx: 0.460, cy: 0.800, r: 0.10, label_zh: '蛇', label_en: 'Snake', emoji: '🐍' },
  ...
  },
  {
    ...
    differences: [
      ...
      { id: 'cmd_3', cx: 0.275, cy: 0.582, r: 0.12, label_zh: '望远镜', label_en: 'Binoculars', emoji: '🔭' },
    ],
  },
  {
    id: 'lounge',
    ...
    cardImg: loungeCard,
    differences: [
      { id: 'lounge_1', cx: 0.746, cy: 0.162, r: 0.13, label_zh: '海报', label_en: 'Poster', emoji: '🖼️' },
      { id: 'lounge_2', cx: 0.849, cy: 0.479, r: 0.10, label_zh: '抱枕', label_en: 'Cushion', emoji: '🛋️' },
      { id: 'lounge_3', cx: 0.148, cy: 0.732, r: 0.10, label_zh: '比萨盒', label_en: 'Pizza box', emoji: '🍕' },
    ],
  },
  {
    id: 'manor',
    ...
    cardImg: manorCard,
    differences: [
      { id: 'manor_1', cx: 0.305, cy: 0.208, r: 0.13, label_zh: '猫咪', label_en: 'Cat', emoji: '🐱' },
      { id: 'manor_2', cx: 0.766, cy: 0.622, r: 0.08, label_zh: '蜡烛台', label_en: 'Candelabra', emoji: '🕯️' },
      { id: 'manor_3', cx: 0.618, cy: 0.428, r: 0.08, label_zh: '鲜花', label_en: 'Flowers', emoji: '💐' },
    ],
  },
  {
    id: 'temple',
    ...
    cardImg: templeCard,
    differences: [
      { id: 'temple_1', cx: 0.389, cy: 0.344, r: 0.12, label_zh: '水晶球', label_en: 'Crystal orb', emoji: '🔮' },
      { id: 'temple_2', cx: 0.608, cy: 0.529, r: 0.11, label_zh: '佛像', label_en: 'Buddha statue', emoji: '🪬' },
  ...
  },
  {
    ...
    cardImg: gymCard,
    differences: [
      { id: 'gym_1', cx: 0.443, cy: 0.447, r: 0.12, label_zh: '擂台绳', label_en: 'Ring ropes', emoji: '🥊' },
      { id: 'gym_2', cx: 0.836, cy: 0.738, r: 0.08, label_zh: '水瓶', label_en: 'Water bottle', emoji: '💧' },
      { id: 'gym_3', cx: 0.914, cy: 0.825, r: 0.08, label_zh: '毛巾', label_en: 'Towel', emoji: '🏋️' },
    ],
  },
];
